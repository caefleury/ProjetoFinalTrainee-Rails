...
Member.find_by(id:1).photo.attach(io: File.open('./public/Homem-Aranha.jpg'), filename: 'Homem-Aranha.jpg')
Member.create!(name: "Lucas", role_id: 2)
Member.find_by(id:2).photo.attach(io: File.open('./public/Lucas.png'), filename: 'Lucas.png')
Member.create!(name: "David", role_id: 2)
Member.find_by(id:3).photo.attach(io: File.open('./public/David.jpg'), filename: 'David.jpg')
Member.create!(name: "Caetano", role_id: 3)
Member.find_by(id:4).photo.attach(io: File.open('./public/Caetano.jpg'), filename: 'Caetano.jpg')
Member.create!(name: "Pedro", role_id: 3)
Member.find_by(id:5).photo.attach(io: File.open('./public/Pedro.jpg'), filename: 'Pedro.jpg')
Member.create!(name: "Arthur", role_id: 3)
Member.find_by(id:6).photo.attach(io: File.open('./public/Arthur.jpg'), filename: 'Arthur.jpg')
Member.create!(name: "Luiz", role_id: 3)
Member.find_by(id:7).photo.attach(io: File.open('./public/Luiz.jpg'), filename: 'Luiz.jpg')
Member.create!(name: "Batman", role_id: 3)
Member.find_by(id:8).photo.attach(io: File.open('./public/Batman.jpg'), filename: 'Batman.jpg')
Member.create!(name: "Super Homi", role_id: 3)
Member.find_by(id:9).photo.attach(io: File.open('./public/Superman.jpg'), filename: 'Superman.jpg')
Member.create!(name: "Flash", role_id: 3)
Member.find_by(id:10).photo.attach(io: File.open('./public/Flash.jpeg'), filename: 'Flash.jpeg')
